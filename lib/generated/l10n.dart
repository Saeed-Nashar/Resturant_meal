...
///You have no Favorites yet-start adding some!
  String get YouHaveNoFavoritesyetStartAddingSome {
    return Intl.message(
      'You have no favorites yet-start adding Some',
      name: 'YouHaveNoFavoritesyetStartAddingSome',
      desc: '',
      args: [],
    );
  }
  ///Spaghetti with Tomato Sauce
  String get SpaghettiWithTomatoSauce {
    return Intl.message(
      'Spaghetti with Tomato Sauce',
      name: 'SpaghettiWithTomatoSauce',
      desc: '',
      args: [],
    );
  }
  ///Light&Lovely
  String get LightAndLovely {
    return Intl.message(
      'Light&Lovely',
      name: 'LightAndLovely',
      desc: '',
...
/// favorite
  ...
  String get choseYourPreferredLanguage{
    return Intl.message(
      'Chose your preferred language',
      name: 'choseYourPreferredLanguage',
      desc: '',
      args: [],
    );
  }
